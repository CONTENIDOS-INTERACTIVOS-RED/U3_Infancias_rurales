        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La infancia en contextos rurales, plantea desafíos singulares que requieren un abordaje pedagógico, social y político diferenciado. Esta unidad explora el marco legal y los modelos educativos que orientan la educación rural en Colombia, analizando cómo las leyes, decretos y resoluciones, buscan garantizar el derecho a la educación de niños y niñas en territorios campesinos. A través del estudio de propuestas como Escuela Nueva y del Programa de Educación Rural (PEER), se reflexionará sobre su impacto en el desarrollo territorial, la equidad educativa y la transformación de las realidades rurales.
              
              p #[b ¡Prepárese para comprender cómo la educación transforma el campo y abre caminos de equidad para las infancias rurales!]
